...
PROVIDER_CAPABILITIES: dict[str, dict[str, Any]] = {
    ...
    # Perplexity
    "perplexity": {
        "supports_response_format": False,  # Perplexity doesn't support OpenAI's response_format
        "supports_streaming": True,
...
MODEL_OVERRIDES: dict[str, dict[str, Any]] = {
    ...
    # Perplexity models (when using openai binding with perplexity endpoint)
    "sonar": {
        "supports_response_format": False,  # Perplexity doesn't support OpenAI's response_format
        "supports_tools": False,  # Perplexity doesn't support function calling
    },
